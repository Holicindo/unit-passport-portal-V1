...
import IssueAnalysisForm from '@/components/reports/IssueAnalysisForm';
import IssueAnalysisTemplate from '@/components/reports/IssueAnalysisTemplate';
import styles from './issue-analysis.module.css';
    ...
    <div className={styles.pageWrapper}>
      ...
      <div className={styles.toolbar}>
        ...
        <h1 className={styles.title}>
          {isEditMode ? 'EDIT' : 'NEW'} FORM INSPEKSI &amp; ANALISIS MASALAH
        </h1>
      ...
      >
        {showPreview
          ? <IssueAnalysisTemplate mode="view" data={form} unit={unit || {}} />
          : <IssueAnalysisForm data={form} onChange={handleChange} />}
      </div>
      ...
      <div className={styles.formFooter}>
        ...
        >
          <Save size={16} />
          {isEditMode ? 'Simpan Perubahan' : 'Simpan Form Inspeksi & Analisis Masalah'}
        </button>
      </div>
      ...
      <Modal
        ...
        title={isEditMode ? 'Simpan Perubahan?' : 'Simpan Form Inspeksi & Analisis Masalah?'}
      ...
      <Modal
        ...
        title={isEditMode ? 'Laporan Berhasil Diperbarui!' : 'Form Inspeksi & Analisis Masalah Berhasil Disimpan!'}
